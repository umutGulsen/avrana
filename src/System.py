...
class System:
    ...
    def __post_init__(self):
        ...
        self.lower_state_constraints = np.zeros((self.state_count, 1)) if self.lower_state_constraints is None else self.lower_state_constraints
        self.upper_state_constraints = 1e3 * np.ones((self.state_count, 1)) if self.upper_state_constraints is None else self.upper_state_constraints
